...
class KafkaEventProducer(clientId: String, config: KafkaProducerConfig) extends EventPublisher[String] {
  ...
  def publish(key: String, event: String, topic: String): Either[Throwable, Unit] = {
